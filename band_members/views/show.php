...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('band_members/manage', 'View All Band Members', array("class" => "button alt"));
        echo anchor('band_members/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('band_members/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Band Member record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
